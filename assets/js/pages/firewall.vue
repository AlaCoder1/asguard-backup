...
export default {
  ...
  methods: {
    ...
    getRulesByInterface(activeTab) {
      ...
      axios
        .get("http://127.0.0.1:8000/rules/GetRulesByInterface/" + activeTab.name_interface)
        .then(response => {
  ...
  watch: {
    activeTab() {
      this.getRulesByInterface(this.tabs[this.activeTab]);
    }
  }
};
</script>
