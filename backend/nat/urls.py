...
urlpatterns = [
    ...
    path('deleteSNat', views_snat.delete_list_snat, name="deleteSNat"),
    ...
    path('deleteOneToOneNat', views_one_to_one_nat.delete_list_one_to_one_nat, name="deleteOneToOneNat"),
    ...
    path('deleteDNat', views_dnat.delete_list_dnat, name="deleteDNat"),
