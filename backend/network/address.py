...
# Read as comma-separated lists
private_address = config("PRIVATE_ADDRESS", default="").split(",")
bogon_address_ip4 = private_address + config("BOGON_ADDRESS_IP4", default="").split(",")
bogon_address_ip6 = config("BOGON_ADDRESS_IP6", default="").split(",")