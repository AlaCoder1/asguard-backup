...
class SdwanRules(models.Model):
    ...
    destination_address = models.CharField(max_length=200, default=None, blank=True)
    health_check = models.CharField(max_length=200, default=None, blank=True, )
    health_check_target = models.CharField(max_length=200, default=None, blank=True)
    primary_interface = models.CharField(max_length=200, default=None, blank=True)
