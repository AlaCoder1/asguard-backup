...
class Command(BaseCommand):
    def handle(self, *args, **kwargs):
        ...
        initBD_plansFeatures("Firewall L4",1)
        initBD_plansFeatures("Networking L2 L3",1)
        initBD_plansFeatures("VPN IPSEC",1)
        
        #FULL
        initBD_plan("Full",1200)
        
        initBD_plansFeatures("Firewall L4",2)
        initBD_plansFeatures("Networking L2 L3",2)
        initBD_plansFeatures("VPN IPSEC",2)
        initBD_plansFeatures("Double Masque",2)
        initBD_plansFeatures("WAF",2)
        initBD_plansFeatures("Anti-virus (owlishield)",2)
        initBD_plansFeatures("IPS",2) 
        initBD_plansFeatures("VPN SSL",2)
        initBD_plansFeatures("Proxy",2)
        initBD_plansFeatures("ZTNA",2)
        initBD_plansFeatures("ZTP",2)
        initBD_plansFeatures("Licence",2)
