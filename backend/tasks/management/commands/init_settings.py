...
from backend.settings.function import create_config_db, execute_all_commandes, get_all_interfaces,manage_commandes
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            ...
            commandes_ssl = [
                    ...
                    "-out /etc/nginx/ssl/asguard.crt -keyout /etc/nginx/ssl/asguard.key"
            ...
            commandes=manage_commandes(all_interfaces,interface_ssh,interface_web,root_login,auth_method,enable_ssh,protocol_http,tcp_port,login_message)
            all_commandes=commandes_ssl+commandes
