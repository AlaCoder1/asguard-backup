...
class Command(BaseCommand):
    def handle(self, *args, **kwargs):
        try:
            ...
            # Initialization of WAF modsecurity rules
            ...
            # Remove line that include all modsecurity conf file (using *.conf) and set each line individually
            ...
            with open(PATH_MAIN_WAF, 'a') as main_file:
                ...
                for rule in LIST_RULES_WAF:
                    # Add modsecrity rule to the main file except the 911 and 920 rules
                    if rule["id"] != "911" and rule["id"] != "920":
