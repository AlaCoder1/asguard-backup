            ...
            <v-container>
              <v-row>
                <v-col cols="12" class="mb-n6">
                  <v-text-field :label="`${$t('sdwan.ruleName')} *`" v-model="state.ruleName"></v-text-field>
                  <p class="error-feedback mb-5" v-if="v$.ruleName.$error">
                    {{ v$.ruleName.$errors[0].$message }}
                  </p>
                </v-col>
                <v-col cols="12" class="mb-n6">
                  <v-textarea rows="1" row-height="15" v-model="state.description" :label="$t('firewall.description')"
                    variant="outlined"></v-textarea>
                </v-col>
                <v-col cols="12" class="mb-n6">
                  <v-select multiple v-model="state.variable" label="Variable *" item-title="name" item-value="slug"
                    :items="state.listVariable" return-object
                ...
                <v-col cols="12" class="mb-n6">
                  <v-select multiple clearable v-model="state.operator" :label="$t('Waf.operator')" item-title="type"
                    item-value="slug" :items="state.listOperator" return-object
                    :no-data-text="$t('certificat.certificatlist')"></v-select>
                ...
                <v-col cols="12" class="d-flex justify-end mb-n6">
                  <v-btn color="#F6F6F6" class="text-none" variant="flat" @click="addNewRow">
                ...
                <v-col cols="12" class="mb-1 mt-0">
                  <ag-grid-vue id="grid-wrapper" domLayout="autoHeight" class="ag-theme-alpine mt-3"
                    :columnDefs="columnWafOperator" :alwaysShowHorizontalScroll="false"
                    :alwaysShowVarticalScroll="false" :rowData="rowDataOperator.value" style="width: 100%; height: 100%"
                    :overlayNoRowsTemplate="overlayTemplate" @grid-ready="onGridReadyOperator" :pagination="true"
                ...
                <template v-if="!state.isActivated">
                  ...
                  <v-col cols="6" class="d-flex justify-end mb-n6">
                    <v-btn color="#F6F6F6" class="text-none" variant="flat" @click="addNewRowTransform">
                      <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <mask id="mask0_50_190" style="mask-type: luminance" maskUnits="userSpaceOnUse" x="0" y="0"
                          width="17" height="17">
                          <path d="M17 0H0V17H17V0Z" fill="white" />
                  ...
                  <v-col cols="12" class="mb-1 mt-0">
                    <ag-grid-vue id="grid-wrapper" domLayout="autoHeight" class="ag-theme-alpine mt-3"
                      :columnDefs="columnWafTransform" :alwaysShowHorizontalScroll="false"
                      :alwaysShowVarticalScroll="false" :rowData="rowDataTransform.value"
                      style="width: 100%; height: 100%" :overlayNoRowsTemplate="overlayTemplate"
                      @grid-ready="onGridReadyTransform" :pagination="true" :paginationPageSize="4"
                      :localeText="paginationLocalization" />
                  </v-col>
                </template>

                <v-col cols="12" class="mb-n6">
                  <v-select multiple v-model="state.actions" label="Actions *" item-title="type" item-value="slug"
                    return-object :items="state.listActions" :no-data-text="$t('certificat.certificatlist')"></v-select>
                ...
                <v-col cols="12" class="mb-n5 mb-1 mt-0">
                  <ag-grid-vue id="grid-wrapper" domLayout="autoHeight" class="ag-theme-alpine mt-3"
                    :columnDefs="columnWaf" :alwaysShowHorizontalScroll="false" :alwaysShowVarticalScroll="false"
                    :rowData="rowDataWaf.value" style="width: 100%; height: 100%"
                    :overlayNoRowsTemplate="overlayTemplate" @grid-ready="onGridReady" :pagination="true"
                    :paginationPageSize="4" :localeText="paginationLocalization" />
                </v-col>
  ...
  setup(props) {
    ...
    const columnWaf = ref([
      ...
      },
      {
        ...
        minWidth: 50,
        flex: 1,
        editable: (params) => params.data.type !== "deny",
        cellStyle: (params) => {
          return params.data.type === "deny"
