<template>
  <v-row justify="center">
    <v-dialog v-model="state.openModal" persistent width="600">
      <form ref="myForm" @submit.prevent="updateServiceRouterP">
        <v-card>
          <v-card-title>
...
export default {
  ...
  setup(props) {
    ...
    const updateServiceRouterP = async () => {
      try {
        ...
        const apiUrl = `/edge/management/v1/service-edge-router-policies/${state.itemId}`;
