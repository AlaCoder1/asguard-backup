<template>
      ...
      <v-col cols="6">
        <v-row class="mt-2">
          ...
          <v-col cols="8" class="mb-n6">
            <input type="checkbox" hide-details disabled v-model="state.enable_dhcpv4" />
          ...
          <v-col cols="8" class="mb-n6">
            <v-text-field :label="$t('dhcpV4.subnetAddress')" v-model="state.subnet_addr" required
          ...
          <v-col cols="8" class="mb-n6">
            ...
            <v-text-field :label="$t('dhcpV4.subnetMask')" v-model="state.subnet_mask" required readonly></v-text-field>
          ...
          <v-col cols="8" class="mb-n6">
            <v-text-field :label="$t('dhcpV4.availableRange')" v-model="state.available_range" required
              readonly></v-text-field>
          ...
          <v-col cols="12">
            ...
            <div style="overflow: hidden; flex-grow: 1">
              <ag-grid-vue id="grid-wrapper" domLayout="autoHeight" class="ag-theme-alpine mt-3" style="width: 100%"
                @grid-ready="onGridReady" :columnDefs="columnRanges" :rowData="rowDataRanges.value"
                :overlayNoRowsTemplate="overlayTemplate" :pagination="true" :paginationPageSize="5"
          ...
          <template v-for="(row, index) in state.rows" :key="index" class="mt-0">
            <v-col cols="4" align-self="center" v-if="index > 0"> </v-col>
            <v-col :cols="index !== 0 ? '7' : '8'" class="mb-n6">
              <v-text-field :label="$t('dhcpV4.dnsServer')" v-model="row.dns_server"></v-text-field>
            </v-col>
            <v-col :cols="index !== 0 ? '1' : '0'" class="mt-4" v-if="index !== 0">
              <v-icon color="red" @click="removeRow(index)" icon="mdi mdi-delete-circle"></v-icon>
            </v-col>
          </template>
          ...
          <v-col cols="12" class="d-flex justify-end">
            <v-btn color="#F6F6F6" class="text-none" variant="flat" @click="addRow">
              <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                <mask id="mask0_50_190" style="mask-type: luminance" maskUnits="userSpaceOnUse" x="0" y="0" width="17"
                  height="17">
          ...
          <v-col cols="8" class="mb-n6">
            <v-text-field :label="$t('dhcpV4.gateway')" v-model="state.gateway" required></v-text-field>
          ...
          <v-col cols="8" class="mb-n6">
            <v-text-field :label="$t('dhcpV4.domainName')" v-model="state.domain_name" required></v-text-field>
          </v-col>
        </v-row>
      </v-col>
    </v-row>

    <ModalAddRanges :isOpen="state.isModalOpen" :editRow="state.editRow" :modalMode="state.modalMode"
      :rowDataList="rowDataRanges.value" :initialRanges="state.available_range" />
  ...
  <v-alert v-model="state.snackbar" :type="state.color" class="d-flex mt-3"
