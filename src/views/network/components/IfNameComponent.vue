            ...
            <div class="mr-2 ml-2">
              <v-row class="mt-2">
                ...
                <v-col cols="6" class="mb-n6">
                  <v-select v-model="value_setup_Ipv4.gateway4.value" :items="allStaticGateways" item-title="gwaddress"
                    item-value="id" return-object :rules="[(v) => !!v || $t('interface.IPV4GatewayRequired')]"
