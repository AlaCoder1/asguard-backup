<template>
  <v-container class="axe-media-print-hide" fluid>
    ...
    <ModalAddIntercept :isOpen="state.isModalInterceptOpen" />
    <ModalAddHost :isOpen="state.isModalHostOpen" />
    <ModalUpdateHost
...
export default {
  ...
  setup() {
    ...
    const state = reactive({
      ...
      modalData: {},
      modalMode: "create",
      isModalInterceptOpen: false,
      isModalHostOpen: false,
      isModalUpdateHostOpen: false,
      isModalUpdateInterceptOpen: false,
      selectedId: null,
      isOpen: null,
      snackbar: false,
      color: null,
