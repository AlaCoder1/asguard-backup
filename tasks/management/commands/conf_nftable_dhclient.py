    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            ...
            def connect_ssh():
                ...
                return ssh
            ssh = connect_ssh()
            commandes_final = ["pacman -Syu --noconfirm","pacman -S nftables --noconfirm","pacman -S dhclient --noconfirm","pacman -S ethtool --noconfirm","mkdir /etc/Dhcp4Config","mkdir /etc/nftables"]
